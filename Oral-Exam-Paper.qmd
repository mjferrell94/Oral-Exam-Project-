...
Oral exams, like other forms of assessment, also comes with unique challenges. First, whereas a written assessment assumes a student's proficiency with the written language, oral exams assume a student's proficiency with the spoken langue.Thus, ESL students may experience difficulties that may diminish the exam's validity, turning a statistics test into an English test. Second, whereas in written exams their is an indirect interaction with the evaluator, in oral exams the interaction is direct. Different biases, such as evaluating a student based on how they've done previously, ..... and even feeling hungry (as one TA mentions later) need to be carefully evaluated. Finally, students with anxiety may react neagatively to the oral format. 

While mitigating these challenges and creating an optimal space for giving oral exams has been shown to be possible with relatively smaller classes, an open problem is how to this with larger class sizes [@Asklund2003],[@Ohmann2019]. As class sizes increase, it becomes necessary to enlist help in the form of other instructors or teaching assistants, potentially increasing the chance for bias in evaluation. Oral exams that, normally, range from 15-45 minutes long **citations** may need to be shortened. Where professors could administer these exams in person, they may instead need to administer them on a computer, using video calling software like zoom.
