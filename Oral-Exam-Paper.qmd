...
Though five of the six GSIs did not discuss any concerns with how the time was being used or differences between the oral exams and how time is used for other things, one GSI did express that even will well spaced time blocks, they were still unable to eat a snack, use the restroom, or walk around. 
...
You can see how they become more critical over time, and that also the last dicussion and the final comments are all about time and timing and scheduling, while the second disucsiion is a lot more about getting the test better, and grading, and making sure things are fair, things we'd want the GSIs to focus on. 
