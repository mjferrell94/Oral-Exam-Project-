...
This study follows six graduate teaching assistants that were instructors of record for one-credit programming courses.

### Course Audience

### Course Structure

These programming courses have a flipped structure where students receive the course content prior to their class meeting time in order to spend most of the class time on activities involving active participation. This is done intentionally as a large proportion of students in the course have little to no experience with computer program. One major frustration for the novice programming is getting stuck, often on something small, and not being able to obtain timely help. The hope is that by flipping the course the students are actively working in class where they are surrounded by their peers and an 'expert' that can both provide assistance when needed. Ideally, this leads to less frustration, more enjoyment of programming, and better understanding.
