...
This was like a maslow's hierarcy of needs type thing, like a GSI needs during large scale exams. It is possible that unless time issue is solved, they will not be able to focus on other issues in depth (bias, reliabilty, validity, grading better?...maybe not) or not foucs on what the exam is trying to allow or accomplish.
