...
Conversations about scheduling centered on two types: when the exam itself was placed in relation to other things and scheduling students to take the oral discussion. After both classes had administered the oral discussions, a small discussion occurred in the second instructor meeting trying to find the best way to place the oral discussion in relation to HW and other school breaks. Though this conversation centered on what may be best for students (e.g., minimizing instructional time lost, placing the discussion so students could get feedback on HW beforehand), a few GSIs in the final oral exam survey commented on what scheduling might be best for them, noting that having final exams and homework on top of the oral discussions "drained" them. They suggested solutions such as having more graders and shifting office hour times. One GSI poignantly noted that "if the oral exam format (the scheduling) goes unchanged, I am unsure if I am fit to be an instructor next semester" due to the heavy workload at the end of the semester.

#### Challenges and Issues

The GSIs reported on several difficulties as they navigated learning to administer oral discussions throughout the semester. The first difficulty centered on technological issues. During the first instructor meeting after the R instructors administered their discussions, they talked about the effects of bad wifi, mix ups with links, and students also experiencing similar technological issues. One GSI noted in the first post oral discussion survey, after both groups had given their first oral discussions, that the Zoom waiting rooms had not worked properly for them. However, after these initial difficulties, no other technological difficulties were discussed.

Distinct from technological difficulties were also experiences where GSIs were challenged to use zoom in new ways. During the first meeting after the R group gave their oral discussions, several GSIs talked among themselves about different ways to record the discussions and download the videos. Though no one talked about the challenges of learning how to use Zoom or other technologies differently after both groups went, in the first post oral discussion survey, one GSI commented "I think of myself as technologically literate but the oral exams have challenged that conception". After the initial burn in period, it appears that the GSIs were able to get a better grasp on using Zoom in different ways.

Another set of challenges came when GSIs had to navigate how accommodate certain students. After both groups had given their oral discussions, one GSI brought up a student who asked if they could do the oral discussion in person, since they had trouble understanding the questions (given in English) over zoom. Another GSI admitted that they had actually given one oral discussion in person to accommodate one student with certain DRO accommodations. After some discussion, the instructors and course coordinator agreed that in order to keep things fair to use other methods if possible, such as the chat option on zoom. Though similar issues were not brought up during the final instructor meeting, one of the same GSIs reiterated the same point on the final survey, indicating ESL students should be given more time since "this \[the oral discussion\] isn't intended to be an English test".

One final challenge the GSIs faced was the time commitment needed to administer the oral discussions. During the first instructor meeting, one GSI was asked how long it took them, and they estimated around 12 hours. Though they didn't indicate how they felt about it, other GSIs in the first post oral discussion survey made their feelings very explicit, saying that it "took way too long" and, for the final oral discussion, they were concerned that "15 hours on Zoom will drive me insane". These initial worries seemed to be confirmed after the final oral discussion was given, with several GSIs commenting on the final post oral discussion survey that the oral discussions were "extremely time inefficient", "very time consuming", and "incredibly grueling". One GSI, during the final instructor meeting, commented "If it were just me with 120 people, I would not do this to myself (talking explicitly about the time commitment)". \[The fact these negative feelings popped up mostly at the end makes sense, since they had other HW, exams, projects, etc.\]

#### Administering the Exam

When it came to conversations about administering the exam itself, the GSIs focused on their experiences with asking follow up questions, interpreting student responses, grading the exam, and self-care. During the first instructor meeting, a discussion ensued about student answers around one question that seemed to cause some difficulty. One GSI prompted in a general way, and another prompted by giving explicit options for students to choose from. The course coordinator offered that the most important thing was consistency in how follow up questions were asked among students, even if they way they were asked was different among instructors. In the second instructor meeting, after both groups had given their oral discussions, there was a discussion on how better follow up prompts could be given. Basing them on what students might say, being consistent, and maybe scaffolding responses were offered as different ways to improve follow up questions. For example, while discussing one question, one GSI said they had asked, "What kind of X" is there, while the course coordinator had started with, "There are two kinds of X. What are they"?.

Even with the instruction on asking better follow-up questions, it could still be a challenge interpreting student responses. Once both groups had given their oral discussions, a few GSIs noted that students "meandered" more around certain questions. After the second oral discussion was given, the GSIs joked about certain questions where even with follow up, students would reword the answers in equally vague ways. "Don't prompt too much", one GSI mentioned in the final survey. "If student \[sic\] doesn't have a clear answer then move on" because "figuring out what students are saying is like squeezing water out of a stone".
