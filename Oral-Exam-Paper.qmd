...
## Discussion
**The goal here is to analyze, not summarize. This means answering questions like
- Based on our findings, what does it mean for designing large scale oral exams in statistics/ data science education contexts?
- Based on our findings, what does it mean for designing large scale oral exams in general?
- How should we support TAs if we are implementing large scale oral exams? 
- Explaining the TA reactions using a framework (Maslow's hierarchy of needs, or just people in stressful situations focusing on survival versus other things.)
- Where to direct TA energy if we are asking them to work with us on design and implementation.

Overall, it means explaining our findings (why did the TAs react the way they did, or feel the way they did potentially?) and explaining what our findings mean (for design, and TA direction, for future research, etc.)
...
Future advice for students was not around the oral discussions, or giving them well, or making the experience better, or how they felt, it was all about scheduling, surviving.
...
This was like a maslow's hierarcy of needs type thing,but a GTA hierarchy of needs. *Is there literature out there about student and TA behavior in crunch time or stressful situations, or is it self evident?* like a GSI needs during large scale exams. It is possible that unless time issue is solved, they will not be able to focus on other issues in depth (bias, reliabilty, validity, grading better?...maybe not) or not foucs on what the exam is trying to allow or accomplish.

Students seeing written closed tests as gold standard like this one, where they saw advantages but thought  a moodle quiz would work...though probably just not wanting to spend so much time on something they see as only giving a little advantage over traditional methods.
